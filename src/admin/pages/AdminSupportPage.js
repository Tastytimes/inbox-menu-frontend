  ...
  return (
    <>
      <header className="admin-header">
        <div>
          <h1>Customer care</h1>
          <p>WhatsApp inbox and order lookup for support agents.</p>
        </div>
      </header>
      ...
      <div className="admin-tabs">
        <button
          type="button"
          className={`admin-btn admin-btn--ghost${activeTab === "whatsapp" ? " admin-btn--active" : ""}`}
        ...
        <button
          type="button"
          className={`admin-btn admin-btn--ghost${activeTab === "orders" ? " admin-btn--active" : ""}`}
