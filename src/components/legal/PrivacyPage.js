...
const PrivacyPage = () => (
  <LegalPageLayout title="Privacy Policy">
    ...
    <p>
      Online payments are processed by <strong>Paytm</strong> and partner banks in{" "}
    ...
    <ul>
      ...
      <li>
        <strong>Payment partners</strong> — Paytm and banking partners for INR transactions
      </li>
      <li>
